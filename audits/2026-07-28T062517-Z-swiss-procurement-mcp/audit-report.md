...
Server `<server>` wurde gegen 36 anwendbare Best-Practice-Checks geprüft. 17 bestanden, 19 Findings dokumentiert (3 critical, 9 high, 7 medium, 0 low). Production-Readiness: NICHT erreicht — blockierend: SCALE-002, SDK-001, SDK-004, SEC-009.
...
All pass criteria of ARCH-003 satisfied. See `checks/ARCH-003` in the mcp-audit catalogue
(catalog_hash 091f446b27965044ce658a1d5f4b2cabe2b0ab5661dcc1a53b6be8f1f2e093c0).
...
All pass criteria of ARCH-012 satisfied. See `checks/ARCH-012` in the mcp-audit catalogue
(catalog_hash 091f446b27965044ce658a1d5f4b2cabe2b0ab5661dcc1a53b6be8f1f2e093c0).
...
12. **SEC-013** (high, partial)
13. **ARCH-002** (medium, partial)
14. **ARCH-003** (medium, partial)
15. **ARCH-011** (medium, partial)
16. **ARCH-012** (medium, partial)
17. **OPS-002** (medium, partial)
18. **SDK-002** (medium, partial)
